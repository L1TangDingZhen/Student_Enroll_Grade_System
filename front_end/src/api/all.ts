...
export function reqRegister(data:any){
    return apiClient.post(`http://192.168.8.115:8000/api/register`, data);
}

export function reqLogin(credentials:any){
    // return request({url:`/login`, method:'post', data:data})
    return apiClient.post(`http://192.168.8.115:8000/api/login`, credentials);
}

export function reqMe(){
    return apiClient.get(`http://192.168.8.115:8000/api/me`,
    {headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}});
}

export function reqAll(){
    return apiClient.get(`http://192.168.8.115:8000/api/num`,
    {headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}});
}

export function reqDelete(id:number){
    return apiClient.delete(`http://192.168.8.115:8000/api/user`,
    {headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}});
    // return request({url:`/api/num/${id}`, method:'delete'})
}

export function reqUpdate(data:any){
    return apiClient.patch(`http://192.168.8.115:8000/api/user`, data,
    {headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}});
...
export function reqCourseList(){
    return apiClient.get(`http://192.168.8.115:8000/api/course`, {
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
}

export function reqCourseListOne(id:number){
    return apiClient.get(`http://192.168.8.115:8000/api/course/${id}`, { 
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
...
export function reqCreateCourse(data:any){
    ...
    return apiClient.post(`http://192.168.8.115:8000/api/course`, data, { 
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
...
export function reqDeleteCourse(id:number){
    return apiClient.delete(`http://192.168.8.115:8000/api/course/${id}`, { 
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
...
export function reqUpdateCourse(data:any, id:number){
    return apiClient.patch(`http://192.168.8.115:8000/api/course/${id}`, data, { 
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
...
export function reqGradeList(){
    return apiClient.get(`http://192.168.8.115:8000/api/grade`, {
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
...
export function reqGradeListOne(id:number){
    return apiClient.get(`http://192.168.8.115:8000/api/grade/${id}`, {
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
...
export function reqCreateGrade(data: any) {
    return apiClient.post(`http://192.168.8.115:8000/api/grade`, data, {
      headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
    });
  }
...
export function reqDeleteGrade(id:number){
    ...
    return apiClient.delete(`http://192.168.8.115:8000/api/grade/${id}`, { 
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
    // return request({url:`/api/grade/${id}`, method:'delete'})
}
export function reqUpdateGrade(data: any, gradeId: number) {
    return apiClient.patch(`http://192.168.8.115:8000/api/grade/${gradeId}`, data, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
    });
}
...
export function reqEnrollList(){
    return apiClient.get(`http://192.168.8.115:8000/api/enroll`, {
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
...
export function reqCreateEnroll(data:any){
    return apiClient.post(`http://192.168.8.115:8000/api/enroll`, data, { 
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
}

export function reqDeleteEnroll(id:number){
    return apiClient.delete(`http://192.168.8.115:8000/api/enroll/${id}`, { 
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    }); 
...
export function reqUpdateEnroll(data:any, id:number){
    return apiClient.patch(`http://192.168.8.115:8000/api/enroll/${id}`, data, { 
        headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
    });
...
export function reqTeacherCourses(){
    ...
    return apiClient.get(`http://192.168.8.115:8000/api/teacher/courses`, { 
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
    });
}

export function reqEnrolledStudents(courseId: string) {
    return apiClient.get(`http://192.168.8.115:8000/api/course/${courseId}/students`,{
      headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
    });
}

export function reqUpdateCourseInfo(courseId: string, data: any) {
    return apiClient.patch(`http://192.168.8.115:8000/api/course/${courseId}`, data, {
      headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
    });
  }

export function reqCreateTeacherCourse(data: any) {
    return apiClient.post(`http://192.168.8.115:8000/api/teacher/create_course`, data, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
    });
    }
